...
<Text style={[styles.sectionTitle, { paddingHorizontal: 24, marginBottom: 15, color: theme.text }]}>Featured & Promoted ✨
                </Text>
                <FlatList
                    horizontal
        ...
        <View style={styles.sectionHeaderRow}>
            <Text style={[styles.sectionTitle, { color: theme.text }]}>Browsing</Text>
